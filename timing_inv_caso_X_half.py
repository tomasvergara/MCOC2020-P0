...
for j in range(1):
    ...
    elemento2 = []
    for i in lista_N: 
        A = matriz_laplaciana(i , np.single)
...
plt.savefig("grafico_half.png" , bbox_inches = "tight") #codigo para guardar imagen del grafico con dimensiones en que se vea todo
