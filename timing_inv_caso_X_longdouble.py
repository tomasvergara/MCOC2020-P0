...
for j in range(1):
    ...
    elemento4 = []
    for i in lista_N: 
        A = matriz_laplaciana(i , np.longdouble)
...
plt.savefig("grafico_longdouble.png" , bbox_inches = "tight") #codigo para guardar imagen del grafico con dimensiones en que se vea todo
